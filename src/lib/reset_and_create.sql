-- =======================================================
-- NEURALIS INTELLIGENCE ECOSYSTEM - FULL RESET & RECREATE
-- =======================================================
-- ⚠️  WARNING: This will DELETE all existing data!
-- Paste this entire script into Supabase SQL Editor and click Run.
-- =======================================================

-- STEP 1: Drop all existing policies (must drop before tables)
DO $$ 
DECLARE
    pol RECORD;
BEGIN
...
DROP TRIGGER IF EXISTS update_customer_queries_modtime ON public.customer_queries;
...
-- STEP 4: Drop all tables (order matters due to foreign keys)
DROP TABLE IF EXISTS public.nrb_updates CASCADE;
DROP TABLE IF EXISTS public.market_data CASCADE;
DROP TABLE IF EXISTS public.metis_briefs CASCADE;
...
-- 2. Users / Profiles Table (Mapped to auth.users)
